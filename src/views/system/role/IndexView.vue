<template>
  <div class="app-container">
    ...
    <el-card shadow="never" class="table-card">
      ...
      <el-table v-loading="loading" :data="roleList" border stripe height="calc(100vh - 200px)">
    ...
    <!-- 🌟 5. 抽屉 C：分配数据规则 (ABAC) -->
    <el-drawer v-model="drawerRuleVisible" :title="`为【${currentRow?.roleName}】配置数据范围`" size="550px" destroy-on-close>
      <div v-loading="drawerLoading" class="drawer-content">
        ...
        >
          ...
          <el-table-column prop="scopeType" label="规则类型" width="100" align="center">
            <template #default="{ row }">
